...
We predicted that endophytes would enhance host fitness under moderate drought, with additional benefits possible when herbivores are present due to anti-herbivore alkaloids (Fig.~\ref{fig:prediction}A). 
Under extreme combined stress, however, the metabolic cost of maintaining the fungus may reduce benefits or even impose a net cost (Fig.~\ref{fig:prediction}B). 
Overall, consistent with the SGH, endophyte-mediated benefits are expected to increase under lower precipitation, with herbivore presence or absence influencing these effects.
