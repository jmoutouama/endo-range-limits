...
\begin{figure}[H]
    ...
    \caption{Standardized coefficients from Bayesian models showing the effects of \textit{Epichloë} endophytes on host grasses. Panels show (a) survival, (b) growth, (c) flowering, and (d) spikelet production. Coefficients represent standardized effect sizes for the interaction drivers: Endophyte $\times$ Climate (bendoclim), Endophyte $\times$ Herbivory (bendoherb), and Endophyte $\times$ Herbivory $\times$ Climate (bendoherbclim). Climate variables were scaled across all species, making coefficients directly comparable. Positive values indicate beneficial endophyte effects, negative values indicate neutral or costly effects. Error bars represent 90\% credible intervals, and a dashed line at 0 denotes no effect.
     }
