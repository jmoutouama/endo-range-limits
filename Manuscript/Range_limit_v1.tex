...
Mutualistic benefits are predicted to increase under environmental stress, but it is unclear how abiotic and biotic factors influence the magnitude of these benefits.
...
Host fitness declined under increasing abiotic stress, and endophyte-infected individuals often fared worse than uninfected ones, suggesting that interactions beneficial under benign conditions can become costly under stress. 
Herbivory had no detectable effect on host demography or endophyte-mediated outcomes.
...
Experimental studies further show that under low nutrient or water conditions, endophyte-infected grasses may produce fewer tillers and lower total biomass compared to endophyte-free plants, reflecting the costs of sharing limited resources \citep{ahlholm2002vertically}.
...
Despite growing interest in the role of symbiosis in shaping host performance, few studies have tested under natural conditions how abiotic and biotic stressors synergistically influence the demographic effects of symbionts along environmental gradients. 
...
Understanding how abiotic stress, biotic stress, and endophyte infection interact requires experiments that jointly vary all three factors. 
However, to our knowledge, no such comprehensive study has been conducted in native grass species.
Here, we address this gap by examining the  additive effects of biotic and abiotic stress on grass-endophyte symbioses in native populations.
...
Grass endophytes, especially those vertically transmitted through seeds, provide a tractable system for studying symbiosis, as infection status (symbiont-free vs. symbiont-infected) can be experimentally manipulated. A well-studied example is the association between cool-season grasses and \textit{Epichloë} fungi \citep{schardl2004symbioses,saikkonen2010defensive,oberhofer2014effects,clay2005herbivores}. 
Endophyte-infected grasses often perform better than endophyte free grasses under water limitation, although benefits can vary with host, endophyte species, or genotype \citep{saikkonen1998fungal}.
Beyond drought tolerance, infection frequency itself is influenced by herbivory and environmental conditions, including long-term variation in precipitation and temperature \citep{rudgers2016long,clay2005herbivores,fowler2025increasing}. 
...
Together, these features make grass–\textit{Epichloë} symbioses an ideal system for investigating how abiotic stressors, such as drought, interact with biotic stressors, like herbivory, to determine the outcome of symbiosis in cool-season grasses.

Across an aridity gradient in the south-central United States, we investigated how endophyte symbiosis affects host-plant demography under varying abiotic and biotic stress. 
This gradient, from mesic conditions in the east to increasingly arid conditions in the west, provides a biologically realistic stress gradient. 
At each site, we manipulated herbivory (allowing herbivore access versus excluding herbivores) to test its interaction with abiotic stress.
We also manipulated endophyte presence, creating endophyte-free and endophyte-infected individuals, to examine the symbiosis between three native cool-season grasses (\emph{Agrostis hyemalis}, \emph{Elymus virginicus}, and \emph{Poa autumnalis}) and their vertically transmitted fungal symbionts (\emph{Epichloë} spp.).
We addressed two questions: (i) under combined abiotic and biotic stress, do endophytes provide fitness benefits or impose costs on their host plants? (ii) which factors (abiotic vs. biotic) determine whether the grass–endophyte interaction benefits or harms the host?
...
In contrast, under high abiotic stress combined with herbivore presence, the grass–endophyte symbiosis may become less mutualistic, as herbivory can suppress or interfere with the positive effects of endophytes and could even impose a net cost (Fig.~\ref{fig:prediction}B; inhibition scenario).
Furthermore, while both abiotic and biotic stress are expected to influence the outcome of endophyte-grass symbiosis, we anticipate that abiotic stress will be the primary driver of mutualistic benefits, with biotic stress modulating the magnitude or direction of those benefits.
%\begin{enumerate}
