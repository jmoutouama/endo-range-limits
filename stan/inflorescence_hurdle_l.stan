...
// Response: count of inflorescences modeled with negative binomial (NO zero inflation)
//
// Fixed predictors:
...
model {
  ...
  // Likelihood: standard negative binomial
...
generated quantities {
  ...
  for (i in 1:N) {
    log_lik[i] =
      neg_binomial_2_log_lpmf(y[i] | predF[i], phi);
  }
}
