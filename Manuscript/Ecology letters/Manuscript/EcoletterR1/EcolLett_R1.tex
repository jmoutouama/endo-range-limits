...
The hurdle model included a Bernoulli component for flowering probability and a zero-truncated negative binomial component for inflorescence count conditional on flowering, with both components using the same linear predictor specified in Eq.~\ref{eq:full_model}}
