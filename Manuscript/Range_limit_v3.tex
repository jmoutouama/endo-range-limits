...
Wetter conditions increased host survival across all species, and variation in abiotic stress altered endophyte effects on survival for two of the three grasses, but in the opposite direction to our original prediction. 
In \textit{A. hyemalis} and \textit{E. virginicus}, grass–\textit{Epichloë} symbiosis shifted from neutral or negative effects under low precipitation to increasingly positive effects as conditions became wetter (Fig.~\ref{fig:Surv}; Fig.~\ref{fig:allstat}).
Under herbivore access, \textit{A. hyemalis} exhibited slightly negative median $\Delta (E^+ - E^-)$ values under low precipitation ($-0.03$--$-0.02$; Pr$(\Delta>0)=0.21$--0.28), shifting toward positive effects under wetter conditions (up to $0.06$; Pr$(\Delta>0)=0.75$--0.82; Table~\ref{tab:delta_summary_surv_quantiles}). 
In \textit{E. virginicus}, median effects were near zero to weakly positive across the precipitation gradient ($0.01$--$0.04$), with moderate support for positive endophyte effects (Pr$(\Delta>0)=0.57$--0.67).
Herbivore exclusion increased the fitness benefits of endophytes under wetter conditions.
In \textit{A. hyemalis}, median $\Delta$ values were clearly negative under dry conditions ($-0.07$--$-0.06$; Pr$(\Delta>0)=0.06$--0.08) but became positive as precipitation increased (up to $0.05$; Pr$(\Delta>0)=0.62$--0.79). 
\textit{E. virginicus} exhibited the strongest precipitation response, with endophyte effects reversing from strongly negative under dry conditions ($\Delta=-0.17$; Pr$(\Delta>0)=0.04$) to strongly positive under wet conditions ($\Delta=0.09$; Pr$(\Delta>0)=0.93$–0.97).
In contrast, \textit{P. autumnalis} showed minimal endophyte effects on survival. 
Under herbivore access, median $\Delta$ values remained slightly negative to near zero ($-0.05$--$0.00$; Pr$(\Delta>0)=0.15$--0.44), while herbivore exclusion produced weakly positive but small effects ($0.00$--$0.02$; Pr$(\Delta>0)=0.58$--0.71; Table~\ref{tab:delta_summary_surv_quantiles}).

Endophyte effects on host growth were species-specific and influenced by both precipitation and herbivore access (Fig.~\ref{fig:growth}; Fig.~\ref{fig:allstat}).  
In \textit{A.~hyemalis}, endophyte effects were neutral to slightly positive under herbivore access at low precipitation ($\Delta = 0.12$--0.23; Pr$(\Delta>0)=0.66$--0.86), becoming strongly positive at moderate-to-high precipitation ($\Delta = 0.33$--0.56; Pr$(\Delta>0)=0.98$--0.99; Table~\ref{tab:delta_summary_grow}). 
Under herbivore exclusion, effects were slightly negative at low precipitation ($\Delta=-0.09$; Pr$(\Delta>0)=0.36$) but increased with precipitation ($\Delta=0.02$--0.37; Pr$(\Delta>0)=0.55$--0.95).  
Under herbivore access, endophyte benefits in \textit{E.~virginicus} were strongest at moderate precipitation and declined at higher precipitation, though remaining positive ($\Delta = 0.55$--0.08; Pr$(\Delta>0)=0.94$--0.63).
Under herbivore exclusion, effects were smaller and more uncertain, ranging from slightly negative at low precipitation ($\Delta=-0.09$; Pr$(\Delta>0)=0.39$) to modestly positive at high precipitation ($\Delta=0.17$; Pr$(\Delta>0)=0.83$; Table~\ref{tab:delta_summary_grow}).  
In \textit{P.~autumnalis}, endophyte effects were variable. 
Under herbivore access, median $\Delta$ ranged from slightly negative at low precipitation to small positive values at high precipitation ($\Delta=-0.22$--0.12; Pr$(\Delta>0)=0.20$--0.74). 
Under herbivore exclusion, benefits were largest at low-to-moderate precipitation ($\Delta=0.21$--0.39; Pr$(\Delta>0)=0.87$--0.94) but declined at higher precipitation, becoming negative at the highest level ($\Delta=-0.34$; Pr$(\Delta>0)=0.04$; Table~\ref{tab:delta_summary_grow}).

Endophyte effects on reproduction were generally neutral at low precipitation and became increasingly positive under wetter conditions, with benefits often slightly stronger under herbivore exclusion (Figs.~\ref{fig:flowering}, \ref{sup:spikelet}; Fig.~\ref{fig:allstat}; Tables~\ref{tab:delta_summary_flow},~\ref{tab:delta_summary_spike}).  
In \textit{A.~hyemalis}, under herbivore access, median $\Delta$ shifted from slightly negative or near zero at low precipitation ($\Delta = -0.27$--$-0.02$; Pr$(\Delta>0)=0.21$--0.48) to positive at moderate-to-high precipitation ($\Delta = 0.53$--1.51; Pr$(\Delta>0)=0.79$--0.88). Under herbivore exclusion, effects were slightly negative at low precipitation ($\Delta=-0.28$--$-0.17$; Pr$(\Delta>0)=0.23$--0.34), increasing to moderately positive at higher precipitation ($\Delta = 0.12$--2.17; Pr$(\Delta>0)=0.60$--0.91).  
\textit{E.~virginicus} showed weak or slightly negative effects at low precipitation under both herbivore treatments ($\Delta=-0.39$--$-0.00$; Pr$(\Delta>0)=0.21$--0.50), becoming modestly positive at higher precipitation ($\Delta = 0.08$--0.42; Pr$(\Delta>0)=0.60$--0.79) under exclusion. Under herbivore access, effects were slightly negative at low-to-moderate precipitation ($\Delta=-0.50$--$-0.14$; Pr$(\Delta>0)=0.36$--0.46), increasing to positive at higher precipitation ($\Delta=0.34$--0.95; Pr$(\Delta>0)=0.61$--0.71).  
In \textit{P.~autumnalis}, endophyte effects increased with precipitation. Under herbivore access, median $\Delta$ ranged from slightly positive at low precipitation ($\Delta=0.08$) to moderately positive at high precipitation ($\Delta=0.91$; Pr$(\Delta>0)=0.79$--0.98). Under herbivore exclusion, benefits were largest at low-to-moderate precipitation ($\Delta=0.68$--1.44; Pr$(\Delta>0)=0.94$--1.00) before declining slightly at the highest precipitation level ($\Delta=1.57$; Pr$(\Delta>0)=0.99$; Tables~\ref{tab:delta_summary_flow},~\ref{tab:delta_summary_spike}).
 
%Credible intervals frequently overlapped zero at low precipitation, indicating that strong reproductive benefits were largely restricted to wetter conditions.
...
\caption{
Predicted survival probability (upper panels) and endophyte effect ($\Delta = E^{+} - E^{-}$; lower panels) across precipitation gradients. 
...
\caption{
Predicted relative growth rate (upper panels) and endophyte effect ($\Delta = E^{+} - E^{-}$; lower panels) across precipitation gradients. 
Lines show posterior means with 90\% credible intervals. 
Points indicate observed means, with point size proportional to sample size. 
Horizontal dashed line denotes $\Delta = 0$. 
Panels are arranged by species and herbivory treatment (herbivore access and exclusion).
...
\caption{
Predicted inflorescence production (upper panels) and endophyte effect ($\Delta = E^{+} - E^{-}$; lower panels) across precipitation gradients. 
Lines show posterior means with 90\% credible intervals. 
Points indicate observed means, with point size proportional to sample size. 
Horizontal dashed line denotes $\Delta = 0$. 
Panels are arranged by species and herbivory treatment (herbivore access and exclusion).
