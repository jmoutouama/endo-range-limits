...
The outcomes of grass–endophyte symbioses across vital rates were primarily associated with climatic variation, with additional contributions from herbivory (Table~\ref{tab:comp_table_driver}).
...
Inflorescence production was best predicted by the \textit{Endophyte}~$\times$~\textit{Herbivory} model, with modest differences from the abiotic–biotic interaction model ($\Delta \mathrm{ELPD} = -1.3$, SE = 2.3) and the \textit{Endophyte}~$\times$~\textit{Climate} model ($\Delta \mathrm{ELPD} = -1.4$, SE = 2.8). 
...
Although these studies focused on Florida scrub herbaceous communities under allelopathic and xeric stress, the general principle that host-associated microbes depend on host condition to provide benefits is broadly applicable and consistent with our observations in cool-season grasses. 
