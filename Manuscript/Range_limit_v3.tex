...
All models included species-specific fixed effects for symbiosis (E+ or E-), precipitation (cumulative rainfall over 12 months preceding the census), and herbivory (herbivore access/exclusion), including all two- and three-way interactions. 
