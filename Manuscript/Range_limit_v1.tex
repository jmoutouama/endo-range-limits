...
To assess whether endophytes confer benefits or impose costs under abiotic and biotic stress, we first developed hierarchical models for survival, growth, and fertility.
...
Secondly, for each vital rate, precipitation was summarized at key quantiles (10th, 25th, 50th, 75th, and 90th percentiles) to represent the range of site-level abiotic stress. 
For each species (\textit{Agrostis hyemalis}, \textit{Elymus virginicus}, \textit{Poa autumnalis}) and herbivory treatment (Fenced or Unfenced), we computed posterior predictions of survival probability for individuals with endophytes (E$^+$) and without endophytes (E$^-$) using the Bayesian model outputs (Equation~\ref{eq:full_model}). 
...
Across fitness components, endophytes generally enhanced host performance under wetter conditions, while effects were costly  or occasionally neutral under drier conditions or in the presence of herbivores.
However, in some contexts, particularly when herbivores were excluded, endophytes conferred clearer benefits.

At low precipitation, endophytes were neutral or slightly costly to survival, but their effects became progressively more beneficial as precipitation increased, particularly when herbivores were excluded (Fig.~\ref{fig:Surv}; Fig.~\ref{sup:survival_delta}). 
In both \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, endophytes provided little to no benefit under drier conditions (median $\Delta(E^{+} - E^{-}) = -0.71$ to $0.10$ in \textit{A.~hyemalis}, Pr($\Delta>0$) $= 0.37$--$0.52$; and $-0.71$ to $0.10$ in \textit{E.~virginicus}, Pr($\Delta>0$) $= 0.37$--$0.61$; Table~\ref{tab:delta_summary_surv}). 
At wetter sites, endophyte effects became increasingly positive in unfenced plots. For \textit{A.~hyemalis}, median $\Delta(E^{+} - E^{-})$ increased to $0.95$--$1.54$, with Pr($\Delta>0$) $= 0.69$--$0.73$; for \textit{E.~virginicus}, values reached $0.95$--$1.54$ and Pr($\Delta>0$) $= 0.82$--$0.84$ (Table~\ref{tab:delta_summary_surv}). In fenced plots, positive effects emerged only at high precipitation and were weaker (Pr($\Delta>0$) $= 0.60$--$0.73$ in \textit{A.~hyemalis}; $0.90$--$0.94$ in \textit{E.~virginicus}). 
In contrast, \textit{Poa autumnalis} showed little evidence of endophyte benefits when herbivores had access, with median $\Delta(E^{+} - E^{-})$ ranging from $-0.71$ to $1.54$, but low probabilities of positive effects (Pr($\Delta>0$) $= 0.02$--$0.08$) across the gradient, indicating that endophyte associations may impose a survival cost under herbivory. Under herbivore exclusion, survival responses were weakly positive across all precipitation levels (median $\Delta(E^{+} - E^{-}) = -0.13$ to $0.11$, Pr($\Delta>0$) $= 0.57$--$0.71$; Table~\ref{tab:delta_summary_surv}), although effect sizes remained small.


Endophytes generally enhanced host growth across the precipitation gradient in all three species, although the magnitude and certainty of their effects differed by species and herbivory treatment (Fig.~\ref{fig:growth}). 
In \textit{Agrostis hyemalis}, endophyte effects on growth became increasingly beneficial with precipitation. In unfenced plots, effects were neutral to mildly beneficial at low-to-moderate precipitation (median $\Delta(E^{+} - E^{-})$ = 0.006--0.093), becoming more clearly beneficial at higher precipitation (median $\Delta$ = 0.170--0.187 at 1979--2163~mm; Pr($\Delta>0$) = 0.56--0.74; Table~\ref{tab:delta_summary_grow}).
In fenced plots, effects were similarly beneficial but smaller and less certain (median $\Delta$ = 0.013--0.198; Pr($\Delta>0$) = 0.52--0.77).
In \textit{Elymus virginicus}, endophytes provided little to no benefit under dry conditions and were occasionally costly (median $\Delta$ = $-0.123$ to $-0.008$; Pr($\Delta>0$) = 0.35--0.49). However, at higher precipitation, effects became increasingly beneficial.
 In unfenced plots, median $\Delta$ reached 0.207--0.238 at 1979--2163~mm with high certainty of benefit (Pr($\Delta>0$) = 0.81--0.82). In fenced plots, benefits were weaker (median $\Delta$ = 0.052--0.063; Pr($\Delta>0$) = 0.61--0.62; Table~\ref{tab:delta_summary_grow}).
In \textit{Poa autumnalis}, endophyte effects were strongly context dependent. In unfenced plots, effects were neutral to mildly beneficial at low precipitation (median $\Delta$ = 0.192--0.258; Pr($\Delta>0$) = 0.69--0.85) and became clearly beneficial at high precipitation (median $\Delta$ = 0.389--0.408; Pr($\Delta>0$) = 0.99--1.00). Under herbivore exclusion, endophyte effects were consistently beneficial across the gradient, with large positive medians (median $\Delta$ = 0.461--1.179; Pr($\Delta>0$) = 0.98--1.00; Table~\ref{tab:delta_summary_grow}).

Endophyte-mediated effects on flowering were positive across all three species (\textit{Agrostis hyemalis}, \textit{Elymus virginicus}, \textit{Poa autumnalis}; Fig.~\ref{fig:flowering}; Table~\ref{tab:delta_summary_flow}), with E$^+$ individuals producing more inflorescences than E$^-$ individuals. This advantage decreased under drier conditions, approaching neutrality at the lowest precipitation levels, but remained substantial under wetter conditions (median $\Delta \sim$ -0.68--1.54 for \textit{Agrostis hyemalis}, -0.68--0.29 for \textit{Elymus virginicus}, 0.002--6.84 for \textit{Poa autumnalis}; Pr($\Delta>0$) $\sim$ 0.49--0.77, 0.35--0.82, 0.69--1.00, respectively).  The effect of herbivore exclusion on endophyte-mediated flowering varies by species: it is weak with no consistent trend for \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, but for \textit{Poa autumnalis}, fencing appears to enhance the positive effect of endophytes (median $\Delta$ up to 6.84; Pr($\Delta>0$) $\sim$ 0.998--1.00).

The effects of endophytes on spikelet production shifted in both direction and magnitude along the precipitation gradient and were influenced by herbivore exclusion, with negative or weak effects at drier sites and increasingly positive effects at wetter sites across species (Fig.~\ref{fig:spikelet}; Fig.~\ref{sup:spike_delta}; Table~\ref{tab:delta_summary_spike}).
In \textit{Elymus virginicus}, the magnitude and direction of endophyte effects changed with precipitation: unfenced plots showed slight costs at the driest sites ($\sim$1035–1277~mm; median $\Delta = -1.41$ to $-0.67$, Pr($\Delta>0$) = 0.27–0.37), whereas benefits emerged at wetter sites ($\sim$1644–2183~mm; median $\Delta = 0.33$–1.57, Pr($\Delta>0$) = 0.56–0.74). Fenced plots exhibited consistently stronger positive effects across the gradient, particularly at high precipitation ($\sim$1644–2183~mm; median $\Delta = 1.52$–3.34, Pr($\Delta>0$) = 0.84–0.92). 
In \textit{Poa autumnalis}, endophyte effects also changed with precipitation: unfenced plots showed weak or negative effects at drier sites ($\sim$1035–1277~mm; median $\Delta = -1.23$ to $-0.76$, Pr($\Delta>0$) = 0.25–0.31), but increasing positive effects at wetter sites ($\sim$1644–2183~mm; median $\Delta = 0.12$–1.49, Pr($\Delta>0$) = 0.54–0.77). Fencing amplified endophyte-mediated spikelet production across the full precipitation gradient ($\sim$1035–2183~mm; median $\Delta = 3.40$–3.58, Pr($\Delta>0$) = 0.91–0.98). 
