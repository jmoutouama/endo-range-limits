...
// Main effects: endophyte (endo), herbivory (herb)
// Interaction: endo × herb
// Random effects: site-year, plot, population
...
parameters {
  ...
  real mu_b0;
  real mu_bendo;      // main effect: endo
  real mu_bherb;      // main effect: herb
  real mu_bendoherb;  // interaction: endo × herb
