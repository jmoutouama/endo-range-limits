...
Under herbivore access, \textit{A. hyemalis} showed slightly negative median $\Delta (S^+ - S^-)$ at low precipitation ($\Delta<-0.03$, $\mathrm{Pr}(\Delta>0)<0.26$), approaching zero at intermediate precipitation and becoming positive under wetter conditions (up to $0.05$, $\mathrm{Pr}(\Delta>0)>0.78$).  
\textit{E. virginicus} increased gradually from near zero ($\Delta=-0.01$, $\mathrm{Pr}(\Delta>0)=0.51$) to moderately positive ($\Delta=0.06$, $\mathrm{Pr}(\Delta>0)=0.72$).  
Herbivore exclusion amplified positive effects at higher precipitation, particularly in \textit{E. virginicus} ($\Delta=-0.11$ to $0.07$, $\mathrm{Pr}(\Delta>0)=0.06$--0.90).  
In contrast, \textit{P. autumnalis} exhibited minimal endophyte effects on survival, with median $\Delta$ near zero under access ($-0.05$ to 0.00, $\mathrm{Pr}(\Delta>0)<0.40$) and weakly positive under exclusion at higher precipitation ($0.03$ to 0.05, $\mathrm{Pr}(\Delta>0)=0.76$--0.77).  

Endophyte effects on growth were species-specific and mediated by precipitation and herbivory (Fig.~\ref{fig:growth}; Fig.~\ref{fig:allstat}).  
In \textit{A. hyemalis}, effects ranged from neutral to moderately positive under herbivore access at low precipitation ($\Delta=0.07$--0.19, $\mathrm{Pr}(\Delta>0)=0.58$--0.80) and became strongly positive at higher precipitation ($\Delta=0.32$--0.60, $\mathrm{Pr}(\Delta>0)=0.98$--0.99).  
Exclusion shifted low-precipitation effects slightly negative ($\Delta=-0.05$, $\mathrm{Pr}(\Delta>0)=0.42$) but increased with wetter conditions ($\Delta=0.04$--0.33, $\mathrm{Pr}(\Delta>0)=0.59$--0.90).  
In \textit{E. virginicus}, growth benefits were positive across precipitation under access ($\Delta=0.26$--0.29, $\mathrm{Pr}(\Delta>0)=0.85$--0.94) and smaller under exclusion ($\Delta=0.04$--0.10, $\mathrm{Pr}(\Delta>0)=0.55$--0.70).  
\textit{P. autumnalis} effects were variable.  
Under access, median $\Delta$ ranged from slightly negative to small positive ($-0.09$--0.04, $\mathrm{Pr}(\Delta>0)=0.37$--0.58).  
Exclusion produced positive effects at low-to-moderate precipitation ($0.13$--0.25, $\mathrm{Pr}(\Delta>0)=0.73$--0.81) but declined to negative at the highest precipitation ($\Delta=-0.25$, $\mathrm{Pr}(\Delta>0)=0.12$).  

Endophyte effects on reproduction were generally neutral or slightly negative under dry conditions and became increasingly positive under wetter conditions, often stronger with herbivore exclusion (Figs.~\ref{fig:flowering}, \ref{sup:spikelet}; Fig.~\ref{fig:allstat}).  
In \textit{A. hyemalis}, median $\Delta$ shifted from slightly negative at low precipitation ($\Delta<-0.02$, $\mathrm{Pr}(\Delta>0)<0.48$) to strongly positive at higher precipitation ($\Delta=0.51$--1.48, $\mathrm{Pr}(\Delta>0)=0.78$--0.86).  
Under herbivore exclusion, effects followed a similar pattern, from negative at low precipitation ($\Delta<-0.20$, $\mathrm{Pr}(\Delta>0)<0.32$) to moderately positive at high precipitation ($\Delta=0.10$--2.19, $\mathrm{Pr}(\Delta>0)=0.58$--0.91).  
\textit{E. virginicus} showed weak or negative effects at low precipitation ($\Delta<-0.03$, $\mathrm{Pr}(\Delta>0)<0.45$), increasing modestly at higher precipitation (up to $0.31$, $\mathrm{Pr}(\Delta>0)=0.68$).  
\textit{P. autumnalis} benefits generally increased with precipitation.  
Under access, median $\Delta=0.09$--0.86 ($\mathrm{Pr}(\Delta>0)=0.52$--0.99).  
Under exclusion, median $\Delta=0.68$--1.58 ($\mathrm{Pr}(\Delta>0)=0.99$--1.00), indicating strong positive effects across wetter conditions.  
...
Survival        & Quadratic   & -0.293 & 0.815 \\
Growth          & Quadratic   & 0      & 0.000 \\
Growth          & Linear      & -0.218 & 1.110 \\
Inflorescence   & Linear      & 0      & 0.000 \\
Inflorescence   & Quadratic   & -0.277 & 0.732 \\
Spikelet        & Linear      & 0      & 0.000 \\
Spikelet        & Quadratic   & -0.894 & 0.467 \\
\hline
\end{tabular}
\end{table}
\clearpage
