...
\begin{enumerate}
	\item {We revised our conceptual framing to incorporate more recent extensions of the stress-gradient hypothesis (SGH), which recognize that positive interactions can weaken or reverse under sufficiently severe or compounding stress, rather than increasing monotonically with stress as in the classic SGH. This revision spans the Introduction (hypotheses), Discussion, and clarifies that our finding of declining endophyte benefits with increasing aridity is consistent with this more nuanced framework rather than a simple contradiction of SGH (Reviewers 1 \& 2).}
...
\response{We thank Reviewer 2 for pointing this out. We have revised the Methods to specify that seeds were surface-sterilized using a 10\% bleach solution and to provide additional details of the sterilization procedure (line \ref{ms-beach}).}
