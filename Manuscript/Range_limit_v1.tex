...
At low precipitation, endophytes were neutral or slightly  costly to survival rate, but their effects became progressively more beneficial as precipitation increased, particularly when herbivores were excluded (Fig.~\ref{fig:Surv}; Fig.~\ref{sup:survival_delta}). 
In both \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, endophytes provided little to no benefit under drier conditions (median $\Delta(E^{+} - E^{-})$  = $-0.705$ to $0.104$ in \textit{A.~hyemalis} and $-0.705$ to $0.104$ in \textit{E.~virginicus}; Pr($\Delta>0$) $\sim 0.33$--$0.52$; Table~\ref{tab:delta_summary_surv}). 
At wetter sites, both species exhibited increasingly positive endophyte effects, especially in unfenced plots (for \textit{A.~hyemalis}, median $\Delta(E^{+} - E^{-})$ = $0.948$--$1.541$, Pr($\Delta>0$) $= 0.69$--$0.73$; for \textit{E.~virginicus}, median $\Delta(E^{+} - E^{-})$ = $0.948$--$1.541$, Pr($\Delta>0$) $= 0.83$--$0.86$; Table~\ref{tab:delta_summary_surv}). 
In fenced plots, positive effects emerged at high precipitation but were weaker (Pr($\Delta>0$) $= 0.60$--$0.72$ in \textit{A.~hyemalis}; $0.90$--$0.94$ in \textit{E.~virginicus}; Table~\ref{tab:delta_summary_surv}). 
In contrast, \textit{Poa autumnalis} showed little evidence of endophyte benefits when herbivores had access, with consistently negative or neutral effects across the gradient (median $\Delta(E^{+} - E^{-})$ = $-0.705$ to $-0.005$, Pr($\Delta>0$) $= 0.14$--$0.43$), indicating that endophyte associations may impose a survival cost under herbivory.
Under herbivore exclusion, survival responses were weakly positive across all precipitation levels (median $\Delta(E^{+} - E^{-})$ = $0.003$--$0.037$, Pr($\Delta>0$) $= 0.55$--$0.71$; Table~\ref{tab:delta_summary_surv}), though effect sizes remained small. 

Endophytes generally enhanced host growth across the precipitation gradient in both \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, whereas in \textit{Poa autumnalis} their effects were weaker and frequently absent or negative, depending on herbivory and precipitation (Fig.~\ref{fig:growth}).
In \textit{Agrostis hyemalis}, unfenced plots showed consistently positive median effects (median$\Delta(E^{+} - E^{-}) $ = 0.410--0.412; Pr($\Delta>0$) = 0.94--0.99;Table~\ref{tab:delta_summary_grow}). In fenced plots, effects remained positive but were smaller and less certain (median $\Delta$ = 0.076--0.255; Pr($\Delta>0$) = 0.65--0.87;Table~\ref{tab:delta_summary_grow}).
\textit{Elymus virginicus} showed a similar pattern: unfenced plots exhibited positive effects across all precipitation levels (median $\Delta$ = 0.218--0.264; Pr($\Delta>0$) = 0.82--0.95;Table~\ref{tab:delta_summary_grow}), while fenced plots showed weaker benefits (median $\Delta(E^{+} - E^{-}) $ = 0.051--0.119; Pr($\Delta>0$) = 0.60--0.77;Table~\ref{tab:delta_summary_grow}).
In \textit{Poa autumnalis}, endophyte effects were highly context dependent. In unfenced plots, medians were negative or near zero at low precipitation (median $\Delta(E^{+} - E^{-}) $= -0.315 to -0.074; Pr($\Delta>0$) = 0.15--0.31), becoming slightly positive only at higher precipitation (median $\Delta$ = 0.113--0.154; Pr($\Delta>0$) = 0.75--0.79). In fenced plots, effects were positive at low-to-moderate precipitation (median $\Delta(E^{+} - E^{-}) $= 0.427--0.034; Pr($\Delta>0$) = 0.59--0.94), but became negative at high precipitation (median $\Delta(E^{+} - E^{-}) $ = -0.271 to -0.336; Pr($\Delta>0$) = 0.04--0.06).



Endophyte-mediated effects on flowering were positive across all three species (\textit{Agrostis hyemalis}, \textit{Elymus virginicus}, \textit{Poa autumnalis}; Fig.~\ref{fig:flowering}; Table~\ref{tab:delta_summary_flow}), with E$^+$ individuals producing more inflorescences than E$^-$ individuals. This advantage decreased under drier conditions, approaching neutrality at the lowest precipitation levels, but remained substantial under wetter conditions (median $\Delta \sim$0.186–3.819; Pr($\Delta>0$) $\gtrsim 0.73$–0.98).
The effect of herbivore exclusion on endophyte-mediated flowering varies by species: it is weak with no consistent trend for \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, but for \textit{Poa autumnalis}, fencing appears to enhance the positive effect of endophytes.

Endophyte effects on spikelet production also shifted along the precipitation gradient and with herbivory (Fig.~\ref{fig:spikelet}; Fig.~\ref{sup:spike_delta}; Table~\ref{tab:delta_summary_spike}). In \textit{Agrostis hyemalis}, endophytes were detrimental at $\sim$1035–1277~mm (median $\Delta = -1.35$ to $-0.63$, Pr($\Delta>0$) = 0.28–0.38) but slightly beneficial at $\sim$1644–2183~mm, particularly when herbivores were excluded (median $\Delta = 0.34$–1.49, Pr($\Delta>0$) = 0.56–0.74). In \textit{Elymus virginicus}, unfenced plots showed costs at drier sites (median $\Delta = -1.00$ to $-0.57$, Pr($\Delta>0$) = 0.29–0.35), whereas fenced plots exhibited consistent benefits across the full gradient (median $\Delta = 3.32$–3.63, Pr($\Delta>0$) $>$0.92).
Herbivore exclusion influences endophyte-mediated spikelet production differently across species: effects are weak for \textit{Agrostis hyemalis}, but fencing enhances the positive effect of endophytes in \textit{Elymus virginicus}.
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{../Figure/Growth_diff_h.pdf}
...
\hline
\textit{Agrostis hyemalis} & Unfenced & 765.76  & -0.0122 & -0.1186 & 0.0747 & 0.3632 \\
\textit{Agrostis hyemalis} & Unfenced & 848.28  & -0.0100 & -0.1037 & 0.0730 & 0.3902 \\
\textit{Agrostis hyemalis} & Unfenced & 1113.25 & 0.0014  & -0.0761 & 0.0824 & 0.5178 \\
\textit{Agrostis hyemalis} & Unfenced & 1644.36 & 0.0248  & -0.0693 & 0.1495 & 0.6919 \\
\textit{Agrostis hyemalis} & Unfenced & 2163.28 & 0.0354  & -0.0825 & 0.2183 & 0.7271 \\
\textit{Agrostis hyemalis} & Fenced   & 765.76  & -0.0484 & -0.1752 & 0.0157 & 0.0993 \\
\textit{Agrostis hyemalis} & Fenced   & 848.28  & -0.0458 & -0.1592 & 0.0184 & 0.1108 \\
\textit{Agrostis hyemalis} & Fenced   & 1113.25 & -0.0263 & -0.1230 & 0.0400 & 0.2305 \\
\textit{Agrostis hyemalis} & Fenced   & 1644.36 & 0.0128  & -0.0932 & 0.1309 & 0.5961 \\
\textit{Agrostis hyemalis} & Fenced   & 2163.28 & 0.0379  & -0.0874 & 0.2119 & 0.7218 \\
\textit{Elymus virginicus} & Unfenced & 765.76  & -0.0328 & -0.1857 & 0.1120 & 0.3318 \\
\textit{Elymus virginicus} & Unfenced & 848.28  & -0.0193 & -0.1430 & 0.1016 & 0.3767 \\
\textit{Elymus virginicus} & Unfenced & 1113.25 & 0.0101  & -0.0822 & 0.1133 & 0.5852 \\
\textit{Elymus virginicus} & Unfenced & 1644.36 & 0.0839  & -0.0615 & 0.2346 & 0.8297 \\
\textit{Elymus virginicus} & Unfenced & 2163.28 & 0.0787  & -0.0529 & 0.2724 & 0.8607 \\
\textit{Elymus virginicus} & Fenced   & 765.76  & -0.1194 & -0.2796 & 0.0353 & 0.0993 \\
\textit{Elymus virginicus} & Fenced   & 848.28  & -0.0856 & -0.2261 & 0.0487 & 0.1430 \\
\textit{Elymus virginicus} & Fenced   & 1113.25 & -0.0007 & -0.1125 & 0.1145 & 0.4957 \\
\textit{Elymus virginicus} & Fenced   & 1644.36 & 0.0951  & -0.0291 & 0.2533 & 0.9004 \\
\textit{Elymus virginicus} & Fenced   & 2163.28 & 0.0509  & -0.0027 & 0.2283 & 0.9388 \\
\textit{Poa autumnalis}    & Unfenced & 765.76  & -0.0075 & -0.0830 & 0.0132 & 0.1807 \\
\textit{Poa autumnalis}    & Unfenced & 848.28  & -0.0216 & -0.1411 & 0.0253 & 0.1679 \\
\textit{Poa autumnalis}    & Unfenced & 1113.25 & -0.0781 & -0.2296 & 0.0430 & 0.1405 \\
\textit{Poa autumnalis}    & Unfenced & 1644.36 & -0.0270 & -0.1601 & 0.0646 & 0.2813 \\
\textit{Poa autumnalis}    & Unfenced & 2163.28 & -0.0051 & -0.1723 & 0.1273 & 0.4303 \\
\textit{Poa autumnalis}    & Fenced   & 765.76  & 0.0033  & -0.0235 & 0.0707 & 0.6813 \\
\textit{Poa autumnalis}    & Fenced   & 848.28  & 0.0101  & -0.0429 & 0.1133 & 0.6895 \\
\textit{Poa autumnalis}    & Fenced   & 1113.25 & 0.0370  & -0.0826 & 0.1773 & 0.7113 \\
\textit{Poa autumnalis}    & Fenced   & 1644.36 & 0.0146  & -0.0902 & 0.1432 & 0.6299 \\
\textit{Poa autumnalis}    & Fenced   & 2163.28 & 0.0034  & -0.1386 & 0.1718 & 0.5505 \\
\hline
\end{tabular}
\end{table}
\end{landscape}
...
Species & Herbivore exclusion & Precipitation (mm) & Median $\Delta$  & Lower 90\% & Upper 90\% & P($\Delta>0$) \\
\hline
\textit{Agrostis hyemalis} & Unfenced & 773.91  & 0.4105  & 0.0143  & 0.8118  & 0.9561 \\
\textit{Agrostis hyemalis} & Unfenced & 1075.09 & 0.4101  & 0.1233  & 0.6986  & 0.9904 \\
\textit{Agrostis hyemalis} & Unfenced & 1316.25 & 0.4117  & 0.1318  & 0.6809  & 0.9930 \\
\textit{Agrostis hyemalis} & Unfenced & 1979.35 & 0.4095  & 0.0138  & 0.7948  & 0.9553 \\
\textit{Agrostis hyemalis} & Unfenced & 2163.28 & 0.4061  & -0.0247 & 0.8358  & 0.9391 \\
\textit{Agrostis hyemalis} & Fenced   & 773.91  & 0.0758  & -0.2386 & 0.3971  & 0.6535 \\
\textit{Agrostis hyemalis} & Fenced   & 1075.09 & 0.1354  & -0.1081 & 0.3712  & 0.8193 \\
\textit{Agrostis hyemalis} & Fenced   & 1316.25 & 0.1700  & -0.0823 & 0.4112  & 0.8655 \\
\textit{Agrostis hyemalis} & Fenced   & 1979.35 & 0.2406  & -0.1388 & 0.6024  & 0.8538 \\
\textit{Agrostis hyemalis} & Fenced   & 2163.28 & 0.2555  & -0.1576 & 0.6517  & 0.8455 \\
\textit{Elymus virginicus} & Unfenced & 773.91  & 0.2182  & -0.1813 & 0.6114  & 0.8209 \\
\textit{Elymus virginicus} & Unfenced & 1075.09 & 0.2344  & -0.0467 & 0.5142  & 0.9128 \\
\textit{Elymus virginicus} & Unfenced & 1316.25 & 0.2423  & -0.0004 & 0.4895  & 0.9497 \\
\textit{Elymus virginicus} & Unfenced & 1979.35 & 0.2594  & -0.0350 & 0.5573  & 0.9265 \\
\textit{Elymus virginicus} & Unfenced & 2163.28 & 0.2638  & -0.0605 & 0.5900  & 0.9103 \\
\textit{Elymus virginicus} & Fenced   & 773.91  & 0.0512  & -0.2910 & 0.3898  & 0.5999 \\
\textit{Elymus virginicus} & Fenced   & 1075.09 & 0.0728  & -0.1559 & 0.2977  & 0.7008 \\
\textit{Elymus virginicus} & Fenced   & 1316.25 & 0.0862  & -0.1047 & 0.2740  & 0.7686 \\
\textit{Elymus virginicus} & Fenced   & 1979.35 & 0.1145  & -0.1400 & 0.3668  & 0.7693 \\
\textit{Elymus virginicus} & Fenced   & 2163.28 & 0.1188  & -0.1616 & 0.4036  & 0.7593 \\
\textit{Poa autumnalis}    & Unfenced & 773.91  & -0.3149 & -0.8195 & 0.1891  & 0.1488 \\
\textit{Poa autumnalis}    & Unfenced & 1075.09 & -0.1650 & -0.4931 & 0.1596  & 0.1985 \\
\textit{Poa autumnalis}    & Unfenced & 1316.25 & -0.0745 & -0.3200 & 0.1718  & 0.3095 \\
\textit{Poa autumnalis}    & Unfenced & 1979.35 & -0.0269 & -0.1606 & 0.3894  & 0.7460 \\
\textit{Poa autumnalis}    & Unfenced & 2163.28 & -0.1583 & -0.4645 & 0.7875  & 0.7873 \\
\textit{Poa autumnalis}    & Fenced   & 773.91  & 0.4274  & -0.0278 & 0.8848  & 0.9395 \\
\textit{Poa autumnalis}    & Fenced   & 1075.09 & 0.1830  & -0.1139 & 0.4870  & 0.8439 \\
\textit{Poa autumnalis}    & Fenced   & 1316.25 & 0.0340  & -0.2068 & 0.2729  & 0.5915 \\
\textit{Poa autumnalis}    & Fenced   & 1979.35 & -0.2709 & -0.5563 & 0.0158  & 0.0588 \\
\textit{Poa autumnalis}    & Fenced   & 2163.28 & -0.3365 & -0.6580 & -0.0158 & 0.0428 \\
\hline
\end{tabular}
\end{table}
\end{landscape}
...
Species & Herbivore exclusion & Precipitation (mm) & Median $\Delta$  & Lower 90\% & Upper 90\% & P($\Delta>0$) \\
\hline
\textit{Agrostis hyemalis} & Unfenced & 773.91  & 0.0073   & -0.6481  & 0.7049  & 0.5090 \\
\textit{Agrostis hyemalis} & Unfenced & 1075.09 & 0.1081   & -0.6629  & 0.9179  & 0.5990 \\
\textit{Agrostis hyemalis} & Unfenced & 1316.25 & 0.2226   & -0.7131  & 1.2676  & 0.6653 \\
\textit{Agrostis hyemalis} & Unfenced & 1979.35 & 0.7145   & -1.3481  & 3.8266  & 0.7277 \\
\textit{Agrostis hyemalis} & Unfenced & 2163.28 & 0.8837   & -1.6786  & 5.0651  & 0.7303 \\
\textit{Agrostis hyemalis} & Fenced   & 773.91  & 0.0314   & -0.7259  & 0.8989  & 0.5313 \\
\textit{Agrostis hyemalis} & Fenced   & 1075.09 & 0.2022   & -0.6737  & 1.2017  & 0.6579 \\
\textit{Agrostis hyemalis} & Fenced   & 1316.25 & 0.4054   & -0.7072  & 1.7487  & 0.7329 \\
\textit{Agrostis hyemalis} & Fenced   & 1979.35 & 1.2135   & -1.6662  & 5.6527  & 0.7679 \\
\textit{Agrostis hyemalis} & Fenced   & 2163.28 & 1.5051   & -2.1199  & 7.5466  & 0.7666 \\
\textit{Elymus virginicus} & Unfenced & 773.91  & -0.0260  & -0.3363  & 0.2906  & 0.4403 \\
\textit{Elymus virginicus} & Unfenced & 1075.09 & 0.0202   & -0.2724  & 0.3317  & 0.5482 \\
\textit{Elymus virginicus} & Unfenced & 1316.25 & 0.0616   & -0.2412  & 0.4022  & 0.6353 \\
\textit{Elymus virginicus} & Unfenced & 1979.35 & 0.1861   & -0.2588  & 0.7886  & 0.7626 \\
\textit{Elymus virginicus} & Unfenced & 2163.28 & 0.2244   & -0.2791  & 0.9456  & 0.7764 \\
\textit{Elymus virginicus} & Fenced   & 773.91  & -0.0840  & -0.7767  & 0.6689  & 0.4158 \\
\textit{Elymus virginicus} & Fenced   & 1075.09 & -0.0427  & -0.6162  & 0.5647  & 0.4470 \\
\textit{Elymus virginicus} & Fenced   & 1316.25 & -0.0051  & -0.5301  & 0.5402  & 0.4931 \\
\textit{Elymus virginicus} & Fenced   & 1979.35 & 0.1117   & -0.6911  & 1.0454  & 0.5966 \\
\textit{Elymus virginicus} & Fenced   & 2163.28 & 0.1439   & -0.8246  & 1.3149  & 0.6075 \\
\textit{Poa autumnalis}    & Unfenced & 773.91  & 0.0114   & -0.0087  & 0.1474  & 0.8576 \\
\textit{Poa autumnalis}    & Unfenced & 1075.09 & 0.0689   & -0.0016  & 0.3791  & 0.9457 \\
\textit{Poa autumnalis}    & Unfenced & 1316.25 & 0.2114   & 0.0263   & 0.9019  & 0.9819 \\
\textit{Poa autumnalis}    & Unfenced & 1979.35 & 2.2625   & 0.2209   & 15.1689 & 0.9907 \\
\textit{Poa autumnalis}    & Unfenced & 2163.28 & 3.8194   & 0.2507   & 32.5599 & 0.9845 \\
\textit{Poa autumnalis}    & Fenced   & 773.91  & 0.0930   & 0.0102   & 0.7815  & 0.9978 \\
\textit{Poa autumnalis}    & Fenced   & 1075.09 & 0.3446   & 0.0697   & 1.4510  & 0.9998 \\
\textit{Poa autumnalis}    & Fenced   & 1316.25 & 0.8133   & 0.1962   & 2.8274  & 1.0000 \\
\textit{Poa autumnalis}    & Fenced   & 1979.35 & 4.6747   & 0.5620   & 29.7732 & 0.9977 \\
\textit{Poa autumnalis}    & Fenced   & 2163.28 & 6.6986   & 0.4783   & 56.0541 & 0.9869 \\
\hline
\end{tabular}
\end{table}
\end{landscape}
...
Species & Herbivore exclusion & Precipitation (mm) & Median $\Delta$  & Lower 90\% & Upper 90\% & P($\Delta>0$) \\
\hline
\textit{Agrostis hyemalis} & Unfenced & 1035.41 & -1.3510 & -5.5804 & 2.5668 & 0.278 \\
\textit{Agrostis hyemalis} & Unfenced & 1276.99 & -0.6338 & -4.3618 & 2.9619 & 0.383 \\
\textit{Agrostis hyemalis} & Unfenced & 1644.36 & 0.3353  & -3.2666 & 4.0509 & 0.563 \\
\textit{Agrostis hyemalis} & Unfenced & 2163.28 & 1.4524  & -2.6777 & 6.3757 & 0.732 \\
\textit{Agrostis hyemalis} & Unfenced & 2182.71 & 1.4931  & -2.6789 & 6.4743 & 0.735 \\
\textit{Agrostis hyemalis} & Fenced   & 1035.41 & -0.9821 & -4.4028 & 2.6021 & 0.314 \\
\textit{Agrostis hyemalis} & Fenced   & 1276.99 & 0.0962  & -2.5845 & 2.9828 & 0.523 \\
\textit{Agrostis hyemalis} & Fenced   & 1644.36 & 1.5183  & -1.0228 & 4.5659 & 0.840 \\
\textit{Agrostis hyemalis} & Fenced   & 2163.28 & 3.1956  & -0.4345 & 8.3976 & 0.925 \\
\textit{Agrostis hyemalis} & Fenced   & 2182.71 & 3.2537  & -0.4157 & 8.5645 & 0.926 \\
\textit{Elymus virginicus} & Unfenced & 1035.41 & -1.0015 & -4.8852 & 2.1675 & 0.285 \\
\textit{Elymus virginicus} & Unfenced & 1276.99 & -0.5677 & -3.4310 & 2.0416 & 0.349 \\
\textit{Elymus virginicus} & Unfenced & 1644.36 & 0.1575  & -2.1394 & 2.5330 & 0.548 \\
\textit{Elymus virginicus} & Unfenced & 2163.28 & 1.2051  & -2.0736 & 5.2885 & 0.735 \\
\textit{Elymus virginicus} & Unfenced & 2182.71 & 1.2429  & -2.0967 & 5.4350 & 0.738 \\
\textit{Elymus virginicus} & Fenced   & 1035.41 & 3.3165  & -0.5986 & 8.2650 & 0.920 \\
\textit{Elymus virginicus} & Fenced   & 1276.99 & 3.5030  & 0.3635  & 7.4336 & 0.966 \\
\textit{Elymus virginicus} & Fenced   & 1644.36 & 3.6124  & 0.7446  & 7.5001 & 0.982 \\
\textit{Elymus virginicus} & Fenced   & 2163.28 & 3.6271  & -0.6306 & 9.5682 & 0.923 \\
\textit{Elymus virginicus} & Fenced   & 2182.71 & 3.6316  & -0.7023 & 9.7111 & 0.919 \\
\hline
\end{tabular}
\end{table}
\end{landscape}
