...
Across fitness components, endophytes tended to enhance host performance under wetter conditions, while effects were detrimental or occasionally neutral under drier conditions or in the presence of herbivores. Fenced sites generally amplified positive effects on reproductive traits (flowering and spikelet production), whereas unfenced sites enhanced positive effects on survival and growth.

Survival declined under lower precipitation, and the effect of endophytes shifted from beneficial under wetter conditions to neutral or slightly costly under drier conditions (Fig.~\ref{fig:Surv}; Fig.~\ref{sup:survival_delta}). For \textit{Agrostis hyemalis} and \textit{Elymus virginicus}, endophytes generally enhanced survival under wetter sites (median $\Delta$~(E$^{+} - $E$^{-}) \sim$0.004–0.033 and 0.023–0.084 at $\sim$1113–2163~mm, Pr($\Delta>0$) $>$0.55–0.84) but became neutral or slightly negative under drier conditions ($\sim$0.007 and $-0.013$ at $\sim$766~mm, Pr($\Delta>0$) $\sim$0.12–0.43; Table~\ref{tab:delta_summary_surv}). In contrast, \textit{Poa autumnalis} showed positive effects of endophytes in fenced plots across the precipitation gradient (median $\Delta \sim$0.005–0.027, Pr($\Delta>0$) $\sim$0.64–0.69), but negative effects when herbivores had access (median $\Delta \sim -0.012$ to $-0.052$, Pr($\Delta>0$) $\sim$0.17–0.25).
