...
\revise{\linelabel{nbind}Each plot was planted with 15 individuals, with 12, 9, 6, or 3 $S^+$ plants and the remainder $S^-$, corresponding to initial endophyte frequencies of 80\%, 60\%, 40\%, or 20\% $S^+$, respectively. This variation in initial endophyte prevalence was not further considered here.}
...
A structural feature of the symbiosis may also contribute to this pattern.
Within a host, endophyte infections last for the life of the infected tissue and are lost only at reproductive transitions, from tillers to seeds or seeds to seedlings \citep{afkhami2009endophyte}.}
\revise{\linelabel{symbiont-retention}
Hosts therefore cannot clear a costly symbiont from already-infected tissue within a single generation, even as conditions deteriorate.
This may create a mismatch between environmental change and symbiont turnover, allowing populations to temporarily retain associations that no longer provide demographic benefits.
We did not assess changes in endophyte prevalence during the experiment and therefore cannot test this possibility directly. 
The consequences of this constraint may depend on the degree of host--symbiont specialization and on the functional characteristics of particular endophyte strains, which could alter both the costs of maintaining the symbiosis and its capacity to confer benefits under stress. 
Testing these mechanisms will require comparing non-structural carbohydrates and tissue nitrogen between plants with and without symbionts across aridity gradients and among host--endophyte systems, to determine whether changes in host resource status help explain why endophyte benefits strengthen under stress in some systems but weaken in others.}
...
Endophytes reduced herbivory damage in \textit{A. hyemalis} and \textit{P. autumnalis}, in keeping with alkaloid-mediated defense, but increased damage in \textit{E. virginicus} (Fig.~\ref{sup:herbivory}), possibly because symbiotic plants were more vigorous and therefore more attractive to herbivores. \revise{\linelabel{alkaloid} 
...
The greenhouse experiment suggests that the endophyte--climate interaction observed in the field is more closely linked to the direct physiological effects of water availability on the host than to soil properties that co-vary with aridity.
When plants were grown in soils from contrasting sites under a common watering regime, plants originating from the driest sites performed poorly even under favorable watering, indicating that soil origin can influence host performance. However, the symbiont $\times$ soil-origin precipitation interaction was negligible for both aboveground biomass and inflorescence production \citep{van2013plant}, suggesting that soil origin may affect host performance without strongly modifying symbiont costs and benefits.
\revise{\linelabel{yeartoyearvariation}The field pattern also included year-to-year variation in precipitation within sites, consistent with a role for contemporaneous water availability, although the field symbiont $\times$ climate interaction was negligible for most species and vital rates (Fig.~S8).}

\revise{\linelabel{range-expansion}The precipitation gradient spanned by our common gardens overlaps with the range margins of these species, making our results relevant to a further question about mutualism and species range dynamics. As environmental change reshapes endophyte prevalence in grasses \citep{fowler2025increasing,li2026climate}, it remains unclear whether symbiosis can buffer host populations at these margins or instead becomes less effective as conditions become more arid.}
\revise{\linelabel{implication}Future work should determine whether climate change affects grass--endophyte associations primarily by altering endophyte persistence itself, or by weakening the benefits endophytes provide to hosts at range margins, since these two mechanisms imply different trajectories for populations at the edge of the species' range.}
