...
These results underscore that the outcome of grass–\textit{Epichloë} symbiosis shifts along abiotic stress gradients \citep{chamberlain2014context,bronstein1994conditional}, providing empirical support for environmentally contingent mutualism in a broadly distributed host–symbiont system.  
...
Under low-precipitation conditions, reduced water availability constrains nutrient uptake and increases the relative metabolic burden of maintaining the endophyte, potentially tipping the cost–benefit balance against endophyte infected plants. 
In addition, severe environmental stress can activate plant defense pathways-such as elevated phytohormone production and reactive oxygen species (ROS) that may inhibit endophyte growth or reduce its functional contributions to the host \citep{bastias2023plant}. 
...
Contrary to the predictions of the stress gradient hypothesis (SGH), which suggests that biotic interactions should become more positive under stressful conditions, endophyte-mediated benefits were reduced under high abiotic stress. 
This reduction likely reflects the metabolic costs of maintaining the endophyte, which can outweigh its benefits when host resources such as water and nutrients are limited. Herbivory effects were generally weak and highly context-dependent, indicating that the symbiosis did not compensate for environmental limitation in the most stressful sites. Together, these results highlight that while herbivory can modulate endophyte effects under some conditions, the outcome of the symbiosis is primarily determined by climatic variation, and its mutualistic benefits are diminished rather than enhanced under extreme stress.
