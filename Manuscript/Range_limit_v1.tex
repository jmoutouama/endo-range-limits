...
Infection frequency is also influenced by herbivory and environmental conditions, including long-term variation in precipitation and temperature \citep{rudgers2016long,clay2005herbivores,fowler2025increasing}. 
...
These characteristics make grass–\textit{Epichloë} symbioses an ideal system for investigating how abiotic stressors, such as drought, interact with biotic stressors, like herbivory, to determine the outcome of symbiosis in cool-season grasses.
...
Here we  address two questions : (i) under combined abiotic  and biotic stress, do endophytes provide fitness benefits or impose costs on their host plants? (ii) which factors ( abiotic vs. biotic) influence whether the grass-endophyte interaction benefits or harms the host plant?
...
Endophyte presence consistently enhances host performance under favorable, wetter conditions, a pattern widely documented across grass–\textit{Epichloë} systems.

Conversely, under high abiotic stress, endophyte effects can be neutral or even detrimental, reflecting the costs of symbiosis under challenging environmental conditions.

Across species and fitness components, climatic variation emerges as the dominant driver of endophyte-mediated effects, while herbivory plays a secondary or context-dependent role.
