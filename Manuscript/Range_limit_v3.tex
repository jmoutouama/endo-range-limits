...
Mutualistic interactions between plants and fungi are widespread and predicted to enhance host fitness under stress, yet abiotic and biotic drivers of their costs and benefits remain unclear.
...
Host fitness declined under high aridity, with endophyte-symbiotic plants showing reduced survival, growth, or reproduction in at least one treatment per species relative to non-symbiotic plants.
...
These results highlight that symbioses can become costly under stress if hosts retain their partners, with implications for the dynamics of plant-fungal mutualisms under global change.
...
Similarly, vertically transmitted endophytes can impose costs on hosts, for example by producing stromata that abort inflorescences or otherwise consume host resources, potentially reducing reproduction \citep{saikkonen2004evolution}. 
...
A well-known example outside plants is coral bleaching, in which heat stress disrupts the mutualistic relationship between corals and their algal symbionts \citep{vidal2009coral,marangon2025destabilization}. 
Across systems, however, how frequently such breakdowns occur, and the environmental or biological limits that govern them, remain largely unknown and must be assessed empirically.
Thus, although stress is often expected to strengthen mutualistic outcomes, there is a clear need to understand how stress can intensify the demographic costs of hosting symbionts, raising fundamental questions about when symbioses enhance versus hinder host performance.
...
Furthermore, it remains unclear how the relative roles of these stressors shape the benefits and costs of symbionts. Most work has been conducted in controlled environments.
...
Seeds from control and heat-treated lineages were surface-sterilized with a 10\% bleach solution and germinated on water agar plates (1.82\% agar; 18.2 g agar per L deionized water).
