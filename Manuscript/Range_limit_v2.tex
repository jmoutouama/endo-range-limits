...
In \textit{Elymus virginicus} and \textit{Poa autumnalis}, endophyte effects were weak or negative under low precipitation but shifted toward positive values at higher precipitation, with benefits generally more pronounced under herbivore exclusion (Fig.~\ref{sup:spikelet}; Fig.~\ref{sup:spike_delta}; Table~\ref{tab:delta_summary_spike}). 
