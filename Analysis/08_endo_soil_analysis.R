...
# Climate data 
Aghy_ppt<- read.csv("https://www.dropbox.com/scl/fi/bst61ph31v0ewz6dyn79k/Agrostis_hyemalis_precipitation.csv?rlkey=xp1hq45eu7h8u6wnuznb9zlh0&dl=1", stringsAsFactors = F)
poa_ppt<- read.csv("https://www.dropbox.com/scl/fi/f6kkq559n795a3pgbdvsi/Poa_autumnalis_precipitation.csv?rlkey=adf5hwslj7uo74ui8c663y9hq&dl=1", stringsAsFactors = F)
elvi_ppt<- read.csv("https://www.dropbox.com/scl/fi/71ospl61twndy42ffz21m/Elymus_virginicus_precipitation.csv?rlkey=qihct3x5kcit7584sp78evcdy&dl=1", stringsAsFactors = F)
