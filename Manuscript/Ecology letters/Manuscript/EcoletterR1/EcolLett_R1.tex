...
\revise{The mechanisms underlying this decline in endophyte benefits with increasing aridity are unclear, but several non-exclusive processes may contribute, consistent with a systematic review noting that positive endophyte effects on drought tolerance are inconsistent across species and understudied for fitness measures such as fecundity and survival \citep{decunta2021systematic}.} 
...
The consequences of this constraint may depend on the degree of host--symbiont specialization and on functional differences among endophytes, which can alter both the costs of maintaining the symbiosis and its capacity to confer benefits under stress \citep{saona2010environmental}.
...
Although soil origin affected plant performance under common watering conditions, the negligible symbiont $\times$ soil-origin precipitation interactions for biomass and inflorescence production indicate that this soil gradient did not reproduce the climate dependence of symbiont effects observed in the field \citep{van2013plant}. 
\revise{\linelabel{soilclimatecaveat}Thus, soil properties can influence host performance, but are unlikely to be the primary driver of climatic variation in symbiont benefits. Instead, direct effects of water availability on host carbon balance, growth, and resource allocation may influence the strength of the association. Nevertheless, the greenhouse experiment does not exclude contributions from specific soil properties that were not independently manipulated.}
...
\caption{Greenhouse experiment testing whether soil-origin precipitation modifies symbiont effects on host performance in \textit{Agrostis hyemalis}. Top row: posterior predictions for aboveground biomass (a) and total inflorescence production (b) across the 30-year mean annual precipitation of the soil-origin site (mm yr$^{-1}$), for symbiont-present ($S^+$) and symbiont-absent ($S^-$) plants; points are observed values, lines are posterior medians, and shaded ribbons are 95\% credible intervals. Middle row: posterior contrast between symbiont treatments ($\Delta$ = $S^+ - S^-$) for biomass (c) and inflorescences (d). (e) Posterior coefficient estimates (median $\pm$ 90\% and 95\% credible intervals) for symbiont presence, precipitation, and their interaction, faceted by response (biomass, top facet; inflorescences, bottom facet). Precipitation increased performance, whereas the Symbiont $\times$ Precipitation interaction was weak.}
