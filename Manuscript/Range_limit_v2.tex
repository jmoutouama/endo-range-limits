...
Herbivory modified some endophyte effects on growth and reproduction in a species-specific manner but did not consistently override climatic effects.
...
Drawing on three years of field experiments and Bayesian demographic models, we evaluated how biotic and abiotic stressors jointly shape the demographic effects of vertically transmitted \textit{Epichloë} endophytes in three cool-season perennial grasses across a natural climatic gradient in the United States. 
Our results allow us to directly evaluate the predictions outlined in our conceptual framework (Fig.~\ref{fig:prediction}). 
...
These patterns do not support SGH-based predictions and instead indicate that increasing abiotic stress constrains both host performance and the capacity of endophytes to provide demographic benefits.
...
Endophyte presence often enhances host performance when abiotic resources, such as water, are sufficient to support both host and fungus.  
These benefits are widely documented across grass-\textit{Epichloë} systems \citep{clay1990fungal}.  
Endophytes can increase host growth, reproduction, and survival \citep{rodriguez2009fungal}, but benefits are strongest under low abiotic stress, such as wetter conditions \citep{gibert2012fungal,clay1988fungal}.  
Mechanistically, hosts must allocate carbon to maintain the endophyte, so under water-rich conditions, the costs of symbiosis are outweighed by the benefits, resulting in net positive effects.  
In our system, endophytes consistently enhanced host performance under wet conditions, whereas herbivore access only occasionally modified these outcomes.
When present, herbivory sometimes amplified endophyte benefits, consistent with endophyte-mediated resistance or tolerance to damage, but these effects were neither strong nor consistent across sites or fitness components, indicating that herbivory was not the dominant driver of endophyte-mediated demography.

While endophyte presence tended to enhance host performance under moderate abiotic conditions, these benefits weakened under severe drought stress.
Under low-precipitation conditions, reduced water availability may constrain nutrient uptake and increase the metabolic burden of maintaining the endophyte, potentially tipping the cost–benefit balance against symbiotic plants \citep{ahlholm2002vertically,bronstein2001exploitation,faeth2002endophytic}. 
A possible mechanism for this is that severe drought can activate plant defense pathways including elevated phytohormone production and reactive oxygen species (ROS) which may inhibit endophyte growth or reduce its functional contributions to the host \citep{bastias2023plant,eaton2011triggers}.
Importantly, mutualism weakening in our study occurred even in the absence of herbivores, indicating that abiotic stress alone can destabilize the host–endophyte relationship. 
This contrasts with studies emphasizing herbivore-mediated context dependence \citep{bastias2017epichloe,afkhami2009endophyte} and suggests that abiotic limitation can independently generate similar outcomes.
...
Although overall inflorescence production was not strongly affected by endophyte presence across the precipitation gradient, spikelet production at the driest sites tended to be lower in endophyte-symbiotic plants. 
...
Across species and fitness components, climatic variation was the primary driver of endophyte-mediated effects, whereas herbivory played a secondary role that depended on site-specific herbivore pressure. 
Precipitation strongly shaped host demography in our system, with drier sites constraining survival, growth, and fertility. 
Contrary to the predictions of the stress gradient hypothesis (SGH), which suggests that biotic interactions should become more positive under stressful conditions \citep{louthan2015and,lortie2006re}, endophyte-mediated benefits were reduced under high abiotic stress. 
Although most empirical tests of SGH have focused on plant–plant interactions \citep{bertness1994positive}, recent syntheses suggest stronger support for SGH among microbial interactions \citep{piccardi2019toxicity,hammarlund2019refining}. 
Our results indicate that plant–microbe mutualisms embedded within host tissues may not conform to this generalization. 
Unlike neighboring plants that can ameliorate stress through external modification of the environment, endophytes depend directly on host physiological condition, including water status, nutrient availability, and carbon balance. 
When these resources are severely constrained, the capacity of endophytes to confer benefits may be fundamentally limited. 
More broadly, our study suggests that the outcomes of endophyte-mediated mutualisms are governed not simply by the presence of stress, but by host physiological capacity under that stress, with important implications for predicting symbiotic responses to increasing drought under climate change.
