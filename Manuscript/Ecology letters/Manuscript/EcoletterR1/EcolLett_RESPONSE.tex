...
\response{We thank Reviewer 1 for catching this error. The values for \textit{A. hyemalis} were inadvertently misinterpreted in the original text. We have revised the sentence in the manuscript (line \ref{ms-herbivoryefficacity}) to report the overall realized effect of the herbivory treatment: plants in herbivore-access plots experienced 24\% tiller damage on average, compared with 14\% in herbivore-exclusion plots, and revised the interpretation accordingly.}
...
\response{We thank Reviewer 3 for pointing this out. We have revised the Methods to specify that seeds were surface-sterilized using a 10\% bleach solution and to provide additional details of the sterilization procedure (line \ref{ms-beach}).}
...
\response{We thank Reviewer 3 for catching this error. The values for \textit{A. hyemalis} were inadvertently misinterpreted in the text. We have corrected the sentence in the revised manuscript (line \ref{ms-herbivoryefficacity}) to accurately report that $S^+$ hosts experienced 19\% herbivore damage compared with 15\% for $S^-$ hosts, and revised the interpretation accordingly.}
