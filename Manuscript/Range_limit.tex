...
%-------------------------------------------------------------------------
\title{\Large When Grass–Endophyte Mutualisms Turn Costly Under Stress}
...
However, the extent to which variation in fungal symbiosis and herbivory affects plant demography across environmental gradients remains unclear. 
...
However, that decline was more pronounced in i host ndividuals having endophytic symbionts, suggesting that plant-fungi interactions that are beneficial under benign conditions may become parasitic under stressful conditions.
Our results highlight that \jacob{ host resistance  at range limits}{Tom wants us to think about this a bit more.} may be hindered by the presence of  mutualist partners.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{PrSurvival_diff.pdf}
\caption{XXX 
}
\label{fig:Surv}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Growth_diff.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Flowering_diff.pdf}
\caption{XXX 
}
\label{fig:flowering}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Spik_ppt_diff.pdf}
\caption{XX
}
\label{fig:spikelet}
\end{figure}
