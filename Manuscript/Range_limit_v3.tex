...
To examine the effects of endophyte symbiosis across an abiotic stress gradient, we established common garden experiments with S+ and S- hosts at seven sites along an aridity gradient from Louisiana to central Texas, US (Fig.~\ref{fig:site}, Table~\ref{tab:exp_sites}).
...
To quantify relative statistical support for abiotic and/or biotic contexts as modifiers of grass-endophyte symbiosis, we fitted four hierarchical Bayesian candidate models for each vital rate (survival, growth, inflorescence, and spikelet production; Supplementary Methods \ref{sec:models}).
...
Similar patterns were observed for growth, inflorescence, and spikelet production, with the \textit{Endophyte}~$\times$~\textit{Climate} model consistently ranking highest, though differences in ELPD among models were smaller for reproductive traits (Table~\ref{tab:comp_table_driver}).  
