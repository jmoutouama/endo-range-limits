...
Endophyte benefits were strongest under benign, mesic conditions and weakened as abiotic stress increased, contrary to the classic SGH prediction. Herbivory effects were inconsistent across species and fitness components, though the strongest effects were in the predicted direction, with herbivore exclusion dampening endophyte benefits. More broadly, symbiosis benefits depended on stress severity and host performance: endophyte benefits were greatest when symbiont-free hosts performed relatively well, but weakened or turned negative when they performed poorly. This is consistent with extensions of the SGH in which positive interactions weaken or shift toward antagonism under sufficiently severe stress \citep{le2010interaction,kawai2007testing,michalet2007highlighting}.}

Endophyte presence is often assumed to enhance host performance under unfavorable environmental conditions. However, our results show that these benefits decline with increasing aridity, consistent with a systematic review noting that positive endophyte effects on drought tolerance are inconsistent across species and understudied for fitness measures such as fecundity and survival \citep{decunta2021systematic}. The mechanisms underlying this pattern remain uncertain, but several non-exclusive processes may contribute. Reduced water availability may limit the host's capacity to benefit from the symbiosis through constrained nutrient uptake, reduced carbon gain, or drought-induced hormonal shifts that impair endophyte function or alter the cost--benefit balance of the interaction \citep{ahlholm2002vertically, bronstein2001exploitation, faeth2002endophytic, bastias2024epichloe, cui2022abscisic}. This interpretation is consistent with the microbial mitigation--exacerbation continuum \citep{david2018microbial}, which predicts that symbionts can shift from beneficial to costly as environmental stress exceeds the host's capacity to sustain the interaction, and with empirical patterns along precipitation gradients in other grass--Epichloë systems \citep{kannadan2008endophyte}. \revise{\linelabel{transmission}Within a host, endophyte infections persist for the life of the infected tissue and are lost only at reproductive transitions, from tillers to seeds or seeds to seedlings \citep{afkhami2009endophyte}; hosts therefore cannot shed a costly symbiont from already-infected tissue within a single generation, even as conditions deteriorate. This apparent conflict with the general assumption of endophyte benefit may reflect variation in host--symbiont specialization, strain identity, and the precipitation regime a population evolved under, any of which could shift the cost--benefit balance above. Testing this will require comparing host and endophyte carbon/nutrient status (e.g., non-structural carbohydrates, tissue nitrogen) in infected versus uninfected plants across an aridity gradient and among systems differing in strain specificity, to determine why stress strengthens the mutualism in some cases and weakens it in others.}
...
\revise{\linelabel{poauclimateindependent}\textit{P. autumnalis} maintained strong reproductive benefits regardless of climate, indicating buffering against abiotic stress, but weaker effects on survival and growth.}
{\textit{P. autumnalis} showed strong reproductive benefits from endophytes, with positive effects on inflorescence production that increased with precipitation, whereas effects on survival and growth were weaker.} 
In contrast, \textit{A. hyemalis} and \textit{E. virginicus} showed \revise{\linelabel{sensitivityclarify}pronounced climate-dependent survival and growth responses, consistent with greater sensitivity to water limitation near their arid range edges} {stronger climate-dependent responses in survival and growth, indicating that endophyte effects varied among host species and vital rates}. 
...
Herbivore exclusion consistently dampened endophyte benefits for growth across species, consistent with an anti-herbivore protective role of \textit{Epichloë} endophytes reinforced under natural herbivore pressure \citep{clay1988fungal, decunta2021systematic}. 
...
Endophytes reduced herbivory damage in \textit{A. hyemalis} and \textit{P. autumnalis}, consistent with alkaloid-mediated defense, but increased damage in \textit{E. virginicus} (Fig.~\ref{sup:herbivory}), possibly because symbiotic plants were more vigorous and therefore more attractive to herbivores. \revise{\linelabel{alkaloid} These species-specific responses may reflect differences in alkaloid identity and potency among endophytes \citep{siegel1990fungal}, together with host condition. Endophyte effects on herbivory are thus unlikely to be a fixed symbiont trait, and their demographic consequences may depend on both endophyte chemistry and the limiting currency for each fitness component.}

The greenhouse experiment suggests that the endophyte--climate interaction observed in the field may be more closely linked to direct physiological effects of water availability than to soil properties that co-vary with aridity. 
\revise{\linelabel{soilorigincaution}When plants were grown in soils from contrasting sites under a common watering regime, the symbiont $\times$ soil-origin precipitation interaction was negligible for both aboveground biomass and inflorescence production \citep{van2013plant}.}{When plants were grown in soils from contrasting sites under a common watering regime, the symbiont $\times$ soil-origin precipitation interaction was negligible for both aboveground biomass and inflorescence production \citep{van2013plant}; however, the endophyte $\times$ climate interaction was also negligible for most species and vital rates in the field (Fig.~S8), so this result warrants caution rather than standing as strong evidence against a role for soil origin.}
These results provide little evidence that soil-origin differences are the primary drivers of the field patterns, though the experiment did not isolate individual soil properties. 
\revise{\linelabel{yeartoyearvariation}This decoupling supports the interpretation that endophyte costs and benefits depend primarily on contemporaneous water availability rather than historical soil conditions.}{Together with year-to-year precipitation variation within sites, this suggests contemporaneous water availability, rather than historical soil conditions alone, drives the climate dependence of endophyte effects.}
Notably, plants from the driest sites performed poorly even under favorable watering, suggesting climatic and edaphic stressors may jointly constrain performance at range margins.

\revise{\linelabel{symbiont-retention}
Host control over symbiont retention may be an underappreciated axis shaping mutualism outcomes along environmental gradients \citep{bronstein2001exploitation}. Because \textit{Epichloë} are tightly integrated with host reproduction, hosts cannot eliminate established symbionts within a generation even when conditions reduce net benefits; however, imperfect vertical transmission can lower symbiont prevalence across generations \citep{afkhami2009endophyte,semmartin2015broad}. We did not assess endophyte presence at experiment's end and cannot test this directly, but our results suggest the SGH may need additional nuance for symbioses in which hosts have limited flexibility to regulate symbiont load \citep{david2018microbial}.
}{
Host control over symbiont retention may be an underappreciated axis shaping mutualism outcomes along environmental gradients \citep{bronstein2001exploitation}. Because \textit{Epichloë} are tightly integrated with host reproduction, hosts may continue bearing symbiont costs even when conditions reduce net benefits, unless imperfect transmission gradually lowers infection frequency across generations. If such costs persist, endophyte prevalence could decline toward the dry end of environmental gradients \citep{semmartin2015broad}. We did not assess endophyte presence at experiment's end, so cannot directly test symbiont retention; nevertheless, the SGH may require additional nuance for symbioses in which hosts have limited flexibility to regulate symbiont load under stress \citep{david2018microbial}.
}

Environmental change can similarly reshape symbiont prevalence elsewhere, including \revise{\linelabel{coral-citation}coral--algal symbiont composition following mass bleaching \citep{souza2023importance}}{breakdown of coral--algal symbioses during marine heat stress \citep{hoeksema2000pursuing}} and endophyte prevalence in grasses under recent climate change \citep{fowler2025increasing,li2026climate}.
\revise{\linelabel{range-expansion}
This same limited host control could shape outcomes at range limits: symbiosis may promote persistence or expansion where endophyte benefits offset the limiting factor, but provide little benefit (or even constrain performance) where the limiting factor is severe resource stress the symbiosis cannot alleviate.
}{
Conversely, whether endophytes expand or constrain host ranges may depend on which factors set range margins. Endophytes may promote expansion when their benefits offset the limiting factor, but provide little benefit when the limiting factor is severe resource stress that symbiosis cannot alleviate.
}
\revise{\linelabel{implication}
Together, these possibilities suggest that the consequences of climate change for grass--endophyte associations depend not only on whether endophytes persist, but on whether their benefits remain sufficient to promote host persistence at range edges.
}{
Together, these possibilities suggest that climate change's consequences for grass--endophyte associations will depend not only on whether endophytes persist, but also on where their demographic benefits remain sufficient to promote host persistence.
}
