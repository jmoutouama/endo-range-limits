...
fit_surv_abio_bio_endo_linear_no3way <- readRDS(url("https://www.dropbox.com/scl/fi/gkbr4355a4bzk9xrun8bp/fit_surv_no3way.rds?rlkey=kw66hm4kimlnfftywv282mvc9&dl=1"))
...
loo_surv_abio_bio_endo_linear_no3way <- compute_loo(fit_surv_abio_bio_endo_linear_no3way)

comp_surv_driver <- loo::loo_compare(loo_surv_endo_clim, loo_surv_endo_herb,loo_surv_abio_bio_endo_linear,loo_surv_abio_bio_endo_linear_wi,loo_surv_abio_bio_endo_linear_no3way)
comp_surv_driver
...
fit_grow_abio_bio_endo_linear_no3way <- readRDS(url("https://www.dropbox.com/scl/fi/rmlx8vckewa8b6xnzx9bu/fit_grow_no3way.rds?rlkey=h2c6a5608f7f5p7ezi5zpmyql&dl=1"))
...
loo_grow_abio_bio_endo_linear_no3way <- compute_loo(fit_grow_abio_bio_endo_linear_no3way)

comp_grow_driver <- loo::loo_compare(loo_grow_endo_clim, loo_grow_endo_herb,loo_grow_abio_bio_endo_linear,loo_grow_abio_bio_endo_linear_wi,loo_grow_abio_bio_endo_linear_no3way)
comp_grow_driver
...
fit_inf_abio_bio_endo_linear_no3way <- readRDS(url("https://www.dropbox.com/scl/fi/2mi1lbt1zpccyfgwtwbuf/fit_inf_endo_no3way.rds?rlkey=x4pfedv6bexr0anyffjqemnfe&dl=1"))
...
loo_inf_abio_bio_endo_linear_no3way <- compute_loo(fit_inf_abio_bio_endo_linear_no3way)

comp_inf_driver <- loo::loo_compare(loo_inf_endo_clim, loo_inf_endo_herb,loo_inf_abio_bio_endo_linear,loo_inf_abio_bio_endo_linear_wi,loo_inf_abio_bio_endo_linear_no3way)
comp_inf_driver
...
fit_spik_abio_bio_endo_linear_no3way <- readRDS(url("https://www.dropbox.com/scl/fi/l7aw861t3zdfwi9yvd8du/fit_spik_abio_bio_endo_linear_wi.rds?rlkey=4tvvcr9kricjgjiqey6kqltct&dl=1"))
...
loo_spik_abio_bio_endo_linear_no3way <- compute_loo(fit_spik_abio_bio_endo_linear_no3way)


comp_spik_driver <- loo::loo_compare(loo_spik_endo_clim, loo_spik_endo_herb,loo_spik_abio_bio_endo_linear,loo_spik_abio_bio_endo_linear_wi,loo_spik_abio_bio_endo_linear_no3way)
comp_spik_driver
