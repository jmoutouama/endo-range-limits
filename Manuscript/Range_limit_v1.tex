...
This gradient, from mesic conditions in the east to increasingly arid conditions in the west, provides a biologically realistic stress continuum. 
At each site, we manipulated herbivory to test its interaction with abiotic stress.
We also experimentally removed endophytes in some individuals to examine the symbiosis between three native cool-season grasses (\emph{Agrostis hyemalis}, \emph{Elymus virginicus}, and \emph{Poa autumnalis}) and their vertically transmitted fungal symbionts (\emph{Epichloë} spp.).
...
Consequently, even in the absence of herbivores, endophyte-mediated benefits may erode or become negative in resource-limited environments, consistent with the reduced performance of infected plants at the driest sites in our study.
