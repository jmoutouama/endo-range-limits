...
Endophyte presence often enhances host performance under favorable or moderately stressful conditions, a pattern widely documented, a pattern widely documented across grass–\textit{Epichloë} systems \citep{clay1990fungal}.
Endophytes can increase host growth, reproduction, and resistance to herbivores \citep{rodriguez2009fungal}, but these benefits are most apparent when the host has sufficient resources, such as water and nutrients, to support the fungus \citep{gibert2012fungal}. 
...
In our field experiment, we observed higher growth and survival of endophyte-infected grasses in wetter sites, consistent with previously documented positive effects of endophytes under favorable conditions.
...
%Interestingly, herbivory had little measurable effect on host performance.
...
This pattern indicates that drought-driven resource limitation can impose costs on the symbiosis independent of biotic stress \citep{johnson1997functioning,bronstein2001exploitation}. 
This contrasts with other studies showing that context-dependent benefits of endophytes are often driven by herbivore pressure. 
For example, in \emph{Bromus setifolia}, high herbivore pressure favors the symbiosis because the benefits outweigh the costs, whereas low herbivore pressure or other high costs select against endophyte infection \citep{rodriguez2009fungal}. 
...
Although we found no evidence of infection-related costs for inflorescences across the precipitation gradient, we did detect a small but consistent cost for spikelet production at the driest sites, suggesting that different reproductive components may vary in sensitivity to drought-mediated shifts in host–endophyte interactions \citep{cheplick2009ecology}.
These abiotic costs also appear to affect reproduction: while inflorescence production showed no detectable cost across the precipitation gradient, spikelet production exhibited a small but consistent cost under the driest conditions, suggesting that resource limitations may disproportionately affect certain reproductive components in infected plants.
...
Precipitation strongly shaped host demography in our system, with drier sites constraining growth and survival. 
Contrary to the predictions of the stress gradient hypothesis (SGH), which suggests that biotic interactions should become more positive under stressful conditions, endophyte-mediated benefits were reduced under high abiotic stress \citep{louthan2015and}. 
Although most empirical tests of the SGH have focused on plant–plant interactions, recent syntheses show that support for the SGH is actually strongest among microbial interactions \citep{piccardi2019toxicity,hammarlund2019refining}, with bacterial systems showing greater conformity to SGH predictions than any other kingdom \citep{adams2022case}. 
