...
Additionally, herbivore access/exclusion effectively modified biotic stress: plants in herbivore-access plots experienced 24\% tiller damage on average, compared to 14\% in exclusion plots (Fig.~\ref{fig:site}F, Fig.~\ref{sup:herb}). 
S+ hosts experienced less herbivore damage than S- hosts in \textit{A. hyemalis} (19\% vs. 15\%) and \textit{P. autumnalis} (13\% vs. 18\%), consistent with 
hypothesized anti-herbivore benefits of endophyte symbiosis, but not in  \textit{E. virginicus} (44\% vs. 42\%; Fig.~\ref{sup:herbivory}).
