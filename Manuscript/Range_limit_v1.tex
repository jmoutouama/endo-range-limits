...
Across an aridity gradient in the south-central United States, we investigated how endophyte symbiosis influences host-plant demography under varying abiotic and biotic stress. 
This region spans a pronounced east–west precipitation gradient, from mesic conditions in the east to increasingly arid conditions in the west, providing a biologically realistic stress gradient. 
At each site, we manipulated herbivory to assess its potential interaction with abiotic stress. 
By experimentally removing the endophyte in some individuals, we examined the symbiosis between three native cool-season grasses (\emph{Agrostis hyemalis}, \emph{Elymus virginicus}, and \emph{Poa autumnalis}) and their vertically transmitted fungal symbionts (\emph{Epichloë} spp.).
...
Benefits were also less pronounced when herbivores had access.
...
\textit{Epichloë} endophyte presence generally enhanced relative growth of individuals across the precipitation gradient, with benefits increasing under wetter conditions and modulated by herbivory (Table~\ref{tab:delta_summary_grow}).
...
\textit{Epichloë} endophytes consistently increased inflorescence production across the precipitation gradient (Figs.~\ref{fig:flowering}). 
By contrast, spikelet production was negatively affected by \textit{Epichloë} under low precipitation but increased under wetter conditions, with effects varying among species and depending on herbivore exclusion (\ref{sup:spikelet}; Figs.~\ref{sup:spike_delta}). 
...
Across species and fitness components, climatic variation emerged as the dominant driver of endophyte-mediated effects, whereas herbivory played a secondary or context-dependent role. 
...
\begin{figure}[ht]
    ...
    (a) \textbf{Stress-amelioration scenario:} Endophytes are predicted to enhance host performance under increasing abiotic stress (e.g., low precipitation) by mitigating drought-related physiological costs. Abiotic stress is the primary driver of host fitness, and endophyte-mediated benefits become more pronounced as stress intensifies. 
    (b) \textbf{Inhibition scenario:} When abiotic stress is combined with an additional biotic stressor herbivory the positive direct effect of endophytes is expected to weaken. Under high combined stress (abiotic + biotic), herbivory suppresses or interferes with drought-mitigation benefits, reducing or eliminating the symbiotic advantage and potentially resulting in a net cost of harboring an endophyte. 
    ...
    Endophyte infection cannot be visually detected in living plants.}
