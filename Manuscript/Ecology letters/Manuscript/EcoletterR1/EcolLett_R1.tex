...
We recorded the number of inflorescences per plant for all species and, for reproducing individuals of \emph{Poa autumnalis} and \emph{Elymus virginicus}, counted spikelets \revise{\linelabel{spikeletmethod}on a maximum of three} inflorescences per plant. Spikelet counts were not recorded for \emph{Agrostis hyemalis} because its inflorescences contain numerous, very small spikelets that are difficult to count reliably in the field.
...
We predicted that endophytes would enhance host fitness under aridity and/or herbivore pressure (Fig.~\ref{fig:prediction}), in line with stress amelioration and defense scenarios. 
\revise{\linelabel{sghdiscussion}
Our results are inconsistent with context-independent mutualism (H1): endophyte effects varied substantially across host species and along the precipitation gradient rather than remaining constant. They are also inconsistent with the climate-dependent hypothesis as formulated (H3), which predicted more positive endophyte effects under arid than wet conditions; instead, benefits were strongest under benign, mesic conditions and weakened as abiotic stress increased, the opposite of the predicted direction. Support for the herbivory-dependent hypothesis (H2) was mixed: effects of herbivore exclusion on endophyte benefits were inconsistent across species and fitness components, though the strongest effects were in the predicted direction, with herbivore exclusion dampening endophyte benefits for growth. We found little evidence for the interactive form of these effects (H4), as herbivory did not consistently amplify endophyte benefits under more arid conditions. More broadly, the benefits of symbiosis depended on stress severity and host performance: they were greatest when symbiont-free hosts performed relatively well, but diminished or turned negative when those hosts performed poorly. This pattern is consistent with extensions of the SGH in which positive interactions weaken or shift toward antagonism under sufficiently severe stress \citep{le2010interaction,kawai2007testing,michalet2007highlighting}.}

\revise{The mechanisms underlying this decline in endophyte benefits with increasing aridity remain uncertain, but several non-exclusive processes may contribute, consistent with a systematic review noting that positive endophyte effects on drought tolerance are inconsistent across species and understudied for fitness measures such as fecundity and survival \citep{decunta2021systematic}.} Reduced water availability may limit the host's capacity to benefit from the symbiosis through constrained nutrient uptake, reduced carbon gain, or drought-induced hormonal shifts that impair endophyte function or alter the cost--benefit balance of the interaction \citep{ahlholm2002vertically, bronstein2001exploitation, faeth2002endophytic, bastias2024epichloe, cui2022abscisic}. This interpretation aligns with the microbial mitigation--exacerbation continuum \citep{david2018microbial}, which predicts that symbionts can shift from beneficial to costly as environmental stress exceeds the host's capacity to sustain the interaction, and with empirical patterns along precipitation gradients in other grass--Epichloë systems \citep{kannadan2008endophyte}.

\revise{\linelabel{transmission}A structural feature of the symbiosis may also contribute to this pattern. Within a host, endophyte infections last for the life of the infected tissue and are lost only at reproductive transitions, from tillers to seeds or seeds to seedlings \citep{afkhami2009endophyte}. Hosts therefore cannot clear a costly symbiont from already-infected tissue within a single generation, even as conditions deteriorate. This apparent conflict with the general assumption of endophyte benefit may reflect variation in host--symbiont specialization, strain identity, and the precipitation regime a population evolved under, any of which could modify the outcome of the interaction. Testing this will require comparing host and endophyte carbon/nutrient status (e.g., non-structural carbohydrates, tissue nitrogen) in infected versus uninfected plants across an aridity gradient and among systems differing in strain specificity, to determine why stress strengthens the mutualism in some cases and weakens it in others.}

\revise{While all host species experienced reductions in performance with increasing aridity, the strength and demographic expression of these climate-dependent effects differed markedly among hosts.}
...
In contrast, \textit{A. hyemalis} and \textit{E. virginicus} showed \revise{\linelabel{sensitivityclarify}pronounced climate-dependent survival and growth responses, suggesting greater sensitivity to water limitation near their arid range margins}. 
...
Endophytes reduced herbivory damage in \textit{A. hyemalis} and \textit{P. autumnalis}, in keeping with alkaloid-mediated defense, but increased damage in \textit{E. virginicus} (Fig.~\ref{sup:herbivory}), possibly because symbiotic plants were more vigorous and therefore more attractive to herbivores. \revise{\linelabel{alkaloid} These species-specific responses may reflect differences in alkaloid identity and potency among endophytes \citep{siegel1990fungal}, together with host condition. Endophyte effects on herbivory are thus unlikely to be a fixed symbiont trait, and their consequences may depend on both endophyte chemistry and the limiting currency for each fitness component.}

\revise{The greenhouse experiment provides little evidence that soil-origin differences explain the field pattern.} 
\revise{\linelabel{soilorigincaution}When plants were grown in soils from contrasting sites under a common watering regime, the symbiont $\times$ soil-origin precipitation interaction was negligible for both aboveground biomass and inflorescence production \citep{van2013plant}; however, because the endophyte $\times$ climate interaction was also negligible for most species and vital rates in the field (Fig.~S8), this result should be interpreted with caution rather than as strong evidence against a role for soil origin.} 
Notably, plants from the driest sites performed poorly even under favorable watering.
\revise{\linelabel{yeartoyearvariation}Together, these results are more consistent with a role for current water availability across the precipitation gradient than with a dominant effect of historical soil conditions, though climatic and edaphic stressors may jointly constrain performance at range margins.}

\revise{\linelabel{symbiont-retention}
This asymmetry between within- and across-generation turnover means symbiont-associated costs can linger in a population well after conditions have made the symbiosis net costly \citep{bronstein2001exploitation,semmartin2015broad}. We did not assess endophyte presence at experiment's end and cannot test this directly, but our results suggest the SGH may need additional nuance for symbioses in which hosts have limited flexibility to regulate symbiont load \citep{david2018microbial}.
}

\revise{\linelabel{range-expansion}Environmental change can reshape endophyte prevalence in grasses \citep{fowler2025increasing,li2026climate}, and because the precipitation gradient spanned by our common gardens may also constrain the range margins of these species, our results speak directly to whether symbiosis buffers host populations at range edges or fails to.}
\revise{\linelabel{implication}Together, these possibilities suggest that the consequences of climate change for grass--endophyte associations depend not only on whether endophytes persist, but on whether their benefits remain sufficient to sustain host populations at range margins.
}
