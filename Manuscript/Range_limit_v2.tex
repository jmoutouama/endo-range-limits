...
In our study, stromata were never observed on \emph{E. virginicus} or \emph{P. autumnalis} and very rarely observed on \emph{A. hyemalis} (<5\% of individuals), suggesting low levels of horizontal transmission.
...
To examine the effects of endophyte symbiosis across an abiotic stress gradient, we established common garden experiments with \tom{E+}{Sometimes this is $E^+$ and elsewhere it is simply E+. I would clean this up.} and E- hosts at seven sites along an aridity gradient from Louisiana to central Texas, US (Fig.~\ref{fig:site}, Table~\ref{tab:exp_sites}).
...
\end{table}
\tom{}{This table is redundant with the new table I added above, and can probably be dropped. But I have left it here because these numbers differ from what is in my table, and I am not sure why.}
\clearpage
