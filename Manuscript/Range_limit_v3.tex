...
\begin{figure}[ht]
		...
		(A) Annual temperature (°C) for 2024 and 2025 census.
...
\begin{figure}[ht]
		...
		Barplots show fenced (dark) versus unfenced (grey) plots for each site (ordered west to east: SON, KER, BFL, BAS, COL, HUN, LAF). 
...
Barplots show fenced (grey80) versus unfenced (grey15) plots for each site (ordered west to east: SON, KER, BFL, BAS, COL, HUN, LAF). 
Error bars indicate standard errors across plots within each site. 
