...
Using three cool-season grass species that host seed-transmitted fungal endophytes, we combined geographically-distributed field experiments across an aridity gradient and Bayesian analysis of demographic performance to test whether plant-fungi interactions affect host demography and, consequently, determine geographic range limits. 
...
Similarly under abiotic stress (e.g., drought), symbionts can increase their host tolerance \citep{clay2002evolutionary}.
 For example, mycorrhizal fungi form extensive networks that increase root surface area, helping plants absorb more water and nutrients such as phosphorus and nitrogen. 
 Symbiotic microbes also stimulate plants to produce antioxidant enzymes like superoxide dismutase and catalase that reduce oxidative damage caused by stresses such as drought, salinity, and heat.
  All of these mechanisms help the host species better buffer against environmental stochasticity \citep{fowler2023geographic}.
...
For instance, symbiotic microbes, especially mycorrhizal fungi, require carbon subsidies from the plant (up to 20\% of photosynthetically fixed carbon). 
At range edges (e.g., cold or dry environments), photosynthesis may be limited, making the carbon cost harder to bear. 
