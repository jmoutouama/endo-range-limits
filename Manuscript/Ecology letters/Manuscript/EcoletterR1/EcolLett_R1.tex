...
Quantifying these thresholds is essential for predicting when stress will strengthen mutualistic outcomes and when it will instead impose demographic costs on hosts.
...
In contrast, \textit{A. hyemalis} and \textit{E. virginicus} showed \revise{\linelabel{sensitivityclarify}pronounced climate-dependent survival and growth responses, consistent with greater sensitivity to water limitation near their arid range edges}. 
...
\revise{\linelabel{yeartoyearvariation}This decoupling supports the interpretation that endophyte costs and benefits depend primarily on contemporaneous water availability rather than historical soil conditions.}
...
Environmental change can similarly reshape symbiont prevalence elsewhere, including \revise{\linelabel{coral-citation}coral--algal symbiont composition following mass bleaching \citep{de2023importance}} and endophyte prevalence in grasses under recent climate change \citep{fowler2025increasing,li2026climate}.
